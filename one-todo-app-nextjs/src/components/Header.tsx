        ...
        <div className="flex items-center gap-4 h-16">
          <div className="flex items-center gap-3">
            ...
            <nav aria-label="Primary" className="hidden sm:flex gap-2">
              <Link href="/" className="px-3 py-1 rounded text-sm text-slate-700 hover:bg-slate-100">
                Home
              </Link>
              <Link href="/todos" className="px-3 py-1 rounded text-sm text-slate-700 hover:bg-slate-100">
                Todos
              </Link>
              <Link href="/about" className="px-3 py-1 rounded text-sm text-slate-700 hover:bg-slate-100">
                About
              </Link>
            </nav>
          </div>
